...
export async function run(source : string, config: any) : Promise<[any, GlobalEnv, string]> {
  ...
  const wasmSource = `(module
    ...
    (func $str$le (import "imports" "str_eq") (param i64) (param i64) (result i64))
    (func $str$lt (import "imports" "str_neq") (param i64) (param i64) (result i64))
    (func $str$ge (import "imports" "str_eq") (param i64) (param i64) (result i64))
    (func $str$gt (import "imports" "str_neq") (param i64) (param i64) (result i64))

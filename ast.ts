...
export type Stmt =
  ...
  | { tag: "if", cond: Expr, condPos: Pos, ifBody: Array<Stmt>, branches: Array<[Expr, Array<Stmt>]>, elseBody: Array<Stmt> }
...
export type Expr =
  ...
  | { tag: "funcCall", pos: Pos, prmPos: Pos, name: string, args: Array<Expr> }
